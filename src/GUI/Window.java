...
public class Window extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
    LinkedList<point> mPoints = new LinkedList<point>();
    point mPivot_point = null;
...
//        this.addMouseMotionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (str.equals("simpleTriangle")) {
            ...
            point p2 = new point(50, 300);
            point p3 = new point(400, 150);
...
//        if (!mMoving_point) {
//            mPoints.add(new point(mPivot_point));
//        }
//        mMoving_point = false;
//        mPivot_point = null;
//        mDraw_pivot = false;
